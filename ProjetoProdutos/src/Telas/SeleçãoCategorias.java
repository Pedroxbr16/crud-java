...
public class SeleçãoCategorias extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					SeleçãoCategorias frame = new SeleçãoCategorias();
	...
	public SeleçãoCategorias() {
		...
		txtcategoria.setModel(new DefaultComboBoxModel(new String[] {"", "Adicionar", "Excluir"}));
